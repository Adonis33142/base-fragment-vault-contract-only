...
BaseSplitVault is a contract-only repository for the BaseSplitVault contract implementation.

Repository: https://github.com/Adonis33142/base-fragment-vault-contract-only.git

## Overview

BaseSplitVault provides a focused workspace for contract development and related project files.
...
4. Make contract changes in a dedicated branch.
5. Run the available project checks or tests.
6. Review the diff before committing changes.
